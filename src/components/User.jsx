...
export const User = ({ id, email, first_name, last_name, avatar, onClickInvite, isInvited }) => (
  <li>
    <div>
      <img className="avatar" src={avatar} alt={id} />
      <div>
    ...
    {isInvited ? (<img onClick={() => onClickInvite(id)} className="action" src={minus} alt="Action" />
    ) : (<img onClick={() => onClickInvite(id)} className="action" src={plus} alt="Action" />
    )}
  </li>
);
